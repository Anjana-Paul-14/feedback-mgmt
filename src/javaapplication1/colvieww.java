...
public class colvieww {
    ...
    public colvieww(String name,String dep,String course,String sem,String Q1,String Q2,String Q3,String Q4,String Q5)
{
this.name=name;
this.dep=dep;
this.course=course;
...
this.Q5=Q5;
    ...
    colvieww(String string, String string0) {
